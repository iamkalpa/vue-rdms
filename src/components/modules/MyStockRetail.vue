   ...
   <div class="row mt-2 purchasemaster_table">
      <div class="col-md-12 col-sm-12">
         <table class="table table-bordered table-hover table-sm">
            ...
            <td align="center">
               <button class="btn btn-red btn-sm m-1" v-if="val['dupl_flag']==0 && val['make']!='MG'" v-on:click="show_component('mystock_retail_edit/status_updates/'+val['id'])">Edit Stock</button>
               <button class="btn btn-red btn-sm m-1" v-if="val['dupl_flag']==0 && val['make']=='MG'" v-on:click="show_component('mystock_retail_edit/status_updates/'+val['id'])">Edit Stock</button>
  ...
  <div class="modal-dialog modal-lg" role="document" style="width: 100%; height:100%">
    ...
    <h5 class="modal-title text-white">Confirm</h5>
     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <h5 class="modal-title" id="exampleModalLabel" style="text-align: center;font-size: 17px;margin-top: 30px;">Are you sure you want to submit these details & push this stock vehicle to Auctions ?</h5>
...
<script>
    ...
    async created() {
        await axios({
                 url: 'http://localhost:5000/getAllRetailStock',
                 method: 'post',
                    params: {
                          min: 10,
                          page: 1
